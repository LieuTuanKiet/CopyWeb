    ...
    return(
        <div>
            <div className="flex flex-col items-center justify-center h-full pt-20">
                ...
                <p className="font-bold text-5xl bg-gradient-to-r from-blue-500 via-blue-500/50 to-pink-500 bg-clip-text text-transparent h-16">Chuyên môn của chúng tôi</p>
                ...
                <div className="bg-gradient-to-b from-blue-500/20 via-gray-100 to-white rounded-lg p-10 cursor-pointer hover:scale-105 duration-200">
                    <div className="relative h-16">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" 
                            ...
                            <path d="M6.003 5.125A3 3 0 0 0 6.401 6.5"></path><path d="M3.477 10.896a4 4 0 0 1 .585-.396"></path><path d="M19.938 10.5a4 4 0 0 1 .585.396">
                            </path><path d="M6 18a4 4 0 0 1-1.967-.516"></path><path d="M19.967 17.484A4 4 0 0 1 18 18"></path>
                        </svg>
                    </div>
                    <p className="font-semibold text-primary text-3xl h-12">Trí tuệ nhân tạo</p>
                    <p className="font-semibold text-primary/60 text-lg max-w-[320px]">Chúng tôi chuyên về trí tuệ nhân tạo, cung cấp các giải pháp AI tiên tiến để tối ưu hóa quy trình kinh doanh và nâng cao hiệu suất.</p>
                </div>
                <div className="bg-gradient-to-b from-blue-500/20 via-gray-100 to-white rounded-lg p-10 cursor-pointer hover:scale-105 duration-200">
                    <div className="relative h-16">
                        <div className="w-8 h-10 bg-blue-500 blur-lg absolute"></div>
                    ...
                    <p className="font-semibold text-primary/60 text-lg max-w-[320px]">Chúng tôi phát triển phần mềm tùy chỉnh, từ ứng dụng di động đến hệ thống quản lý doanh nghiệp, đáp ứng nhu cầu đa dạng của khách hàng</p>
                </div>
                <div className="bg-gradient-to-b from-blue-500/20 via-gray-100 to-white rounded-lg p-10 cursor-pointer hover:scale-105 duration-200">
                    <div className="relative h-16">
                        <div className="w-8 h-10 bg-blue-500 blur-lg absolute"></div>
                    ...
                    <p className="font-semibold text-primary/60 text-lg max-w-[320px]">Chúng tôi cung cấp các giải pháp giáo dục trực tuyến, bao gồm khóa học, nền tảng học tập và công cụ hỗ trợ giảng dạy.</p>
                </div>
            </div>
        </div>
    )
