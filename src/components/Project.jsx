    ...
    return(
        <div className="my-16 pt-32">
            <div className="flex flex-col justify-center items-center">
                ...
                <p className="font-semibold text-primary/60 text-lg h-16">Chúng tôi đã thực hiện nhiều dự án công nghệ và nghiên cứu, mang lại giá trị cho cộng đồng và khách hàng.</p>
            </div>
            <div className="container mx-auto flex gap-x-6 mb-6">
                <div className="w-1/3 bg-white border-gray-300 border-[1px] rounded-xl p-6 group">
                    <div className="mb-4 overflow-hidden rounded-xl">
                        <img src={froggit} className="aspect-square rounded-xl h-full w-full max-w-[375px] max-h-[200px] object-cover group-hover:scale-105 duration-200"></img>
                    </div>
                    <p className="text-primary font-semibold text-2xl h-10">Du An 1</p>
                    <p className="text-primary/60 font-semibold text-md mb-4 max-w-[350px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique fugiat perferendis hic sequi consequatur sed nulla, officia 
                        sunt aliquid assumendam. Quis!
                    </p>
                ...
                <div className="w-1/3 bg-white border-gray-300 border-[1px] rounded-xl p-6 group">
                    <div className="mb-4 overflow-hidden rounded-xl">
                        <img src={whale} className="aspect-square rounded-xl h-full w-full max-w-[375px] max-h-[200px] object-cover group-hover:scale-105 duration-200"></img>
                    </div>
                    <p className="text-primary font-semibold text-2xl h-10">Du An 2</p>
                    <p className="text-primary/60 font-semibold text-md mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique fugiat perferendis hic sequi consequatur sed nulla, officia 
                        sunt aliquid assumendam. Quis!
                    </p>
                    <div className="flex justify-between items-center">
                        <p className="text-blue-600 font-semibold hover:underline cursor-pointer"><a href="">Xem chi tiết</a></p>
                ...
                <div className="w-1/3 bg-white border-gray-300 border-[1px] rounded-xl p-6 group">
                    <div className="mb-4 overflow-hidden rounded-xl">
                        <img src={vue} className="aspect-square rounded-xl h-full w-full max-w-[375px] max-h-[200px] object-cover group-hover:scale-105 duration-200"></img>
                    </div>
            ...
            <div className="container mx-auto flex justify-center items-center">
                <button className="bg-blue-500 text-white rounded-md px-6 py-2 font-bold text-lg shadow-blue-500/80 shadow-lg hover:scale-95 duration-200">Tất cả dự án</button>
            </div>
        </div>
    )
}