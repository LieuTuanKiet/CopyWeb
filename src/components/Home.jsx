    ...
    return(
        <div className="flex container mx-auto justify-center items-center mt-56 h-full pb-20">
            <div className="w-1/2">
                ...
                <p className="text-xl text-primary/40 h-16"><span className="text-2xl font-semibold text-primary">
                    Crush your backlog</span> with us AI engineering team.
                </p>
                <div>
                    <button className="w-48 rounded-lg bg-blue-500 text-white font-semibold p-2 shadow-lg shadow-blue-500/50 
                        hover:scale-95 duration-200">Dự án của chúng tôi
                    </button>
                    <button className="w-44 rounded-lg text-pink-600 font-semibold border-solid border-pink-600 border-2 p-2 ml-6 
